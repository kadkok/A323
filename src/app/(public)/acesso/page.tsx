...
export default function Page() {
  return (
    <Card>
      ...
      <h1 className="mt-4 text-3xl font-semibold text-white">Acesso</h1>
      ...
      <Link href="/login" className="mt-6 inline-flex rounded-xl border border-sky-400/30 px-4 py-2 text-sm text-sky-200">Ir para login seguro</Link>
    </Card>
  );
}
